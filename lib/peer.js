...
// ── SDP encoding — deflate-raw + URL-safe base64 ──────────────────────────────
// CompressionStream reduces a typical SDP from ~1000 chars to ~350, making the
// QR code small enough to scan reliably. Falls back to plain base64 if the API
// is unavailable (pre-Safari 16.4 / pre-Firefox 113).
async function peerEncode(text) {
