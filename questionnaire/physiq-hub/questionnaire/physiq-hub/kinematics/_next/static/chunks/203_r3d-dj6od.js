...
`}),a5={kernelName:am.Acos,backendName:"webgl",kernelFunc:a3},a6=aF({opSnippet:at+`
  if (x < 1.0) return NAN;
return log(x + sqrt(x * x - 1.0));`}),a8={kernelName:am.Acosh,backendName:"webgl",kernelFunc:a6},a7="return a + b;",a9=aD({opSnippet:a7,packedOpSnippet:a7,supportsComplex:!0,cpuKernelImpl:ts}),ne={kernelName:am.Add,backendName:"webgl",kernelFunc:a9};class nt{constructor(e,t){this.outputShape=[],this.outputShape=e,this.variableNames=t.map((e,t)=>`T${t}`);const a=[];this.variableNames.forEach(e=>{a.push(`float v${e} = get${e}AtOutCoords();`)});const n=this.variableNames.map(e=>`v${e}`).join(" + ");this.userCode=`
      void main() {
        ${a.join("\n        ")}
...
`,packedOpSnippet:`
  ...
  return result;
`,cpuKernelImpl:tx,dtype:"float32"}),r4={kernelName:am.Exp,backendName:"webgl",kernelFunc:r2};function r3(e){let{inputs:t,attrs:a,backend:n}=e,{dim:r}=a,{input:i}=t,o=i.shape.length,s=i.shape.slice(),l=r;return r<0&&(v.util.assert(-(o+1)<=r,()=>`Axis must be in the interval [${-(o+1)}, ${o}]`),l=o+r+1),s.splice(l,0,1),aG({inputs:{x:i},backend:n,attrs:{shape:s}})}let r5={kernelName:am.ExpandDims,backendName:"webgl",kernelFunc:r3},r6="return exp(x) - 1.0;",r8=aF({opSnippet:r6,packedOpSnippet:r6,cpuKernelImpl:tm}),r7={kernelName:am.Expm1,backendName:"webgl",kernelFunc:r8};class r9{constructor(e,t,a){let n;this.variableNames=["real","imag"];const r=t[1];this.outputShape=t;const i=a?`2.0 * ${Math.PI}`:`-2.0 * ${Math.PI}`,o=a?`${r}.0`:"1.0";if("real"===e)n="return real * expR - imag * expI;";else if("imag"===e)n="return real * expI + imag * expR;";else throw Error(`FFT component must be either "real" or "imag", got ${e}.`);this.userCode=`
...
`}),oJ={kernelName:am.Relu6,backendName:"webgl",kernelFunc:oZ};class o0{constructor(e,t,a,n,r){this.variableNames=["A"],this.outputShape=[];const[i,o,s,l]=e;this.outputShape=[i,t,a,l];const u=[n&&t>1?o-1:o,n&&a>1?s-1:s],d=[n&&t>1?t-1:t,n&&a>1?a-1:a];this.userCode=`
    ...
    `}}let o8={kernelName:am.ResizeNearestNeighbor,backendName:"webgl",kernelFunc:function(e){let{inputs:t,backend:a,attrs:n}=e,{images:r}=t,{alignCorners:i,halfPixelCenters:o,size:s}=n,[l,u]=s,d=(0,g.env)().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new o6(r.shape,l,u,i,o):new o5(r.shape,l,u,i,o);return a.runWebGLProgram(d,[r],r.dtype)}};class o7{constructor(e,t,a){this.variableNames=["dy"],this.outputShape=[],this.outputShape=t;const[,n,r]=t,[,i,o]=e,s=[a&&i>1?n-1:n,a&&o>1?r-1:r],l=[a&&i>1?i-1:i,a&&o>1?o-1:o],u=s[0]/l[0],d=s[1]/l[1],c=1/u,p=1/d,h=2*Math.ceil(c)+2,f=2*Math.ceil(p)+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
    ...
    `}}let o9={kernelName:am.ResizeNearestNeighborGrad,backendName:"webgl",kernelFunc:function(e){let{inputs:t,backend:a,attrs:n}=e,{images:r,dy:i}=t,{alignCorners:o}=n,s=new o7(i.shape,r.shape,o);return a.runWebGLProgram(s,[i],i.dtype)}};class se{constructor(e,t){this.variableNames=["x"];const a=e.length;if(a>4)throw Error(`WebGL backend: Reverse of rank-${a} tensor is not yet supported`);if(this.outputShape=e,1===a){this.userCode=`
        void main() {
