...
```js
{
  ...
  kinematics:        array  | null,   // physiq-kinematics recordings ({ joints[], series{joint:{t,a}}, duration })
  kinematicsDraft:   object | null,   // physiq-kinematics in-progress draft (WIP state)
...
| `SESSION_KINEMATICS` | `kinematics` | `session.kinematics` |
